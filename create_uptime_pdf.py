    ...
    for country in ['KZ', 'KG', 'UZ']:
        ...
        try:
            ...
            for img in imgs:
                ...
                """
            html_content += f'<div class="page-break"></div><div style="font-size: 18px; font-weight: bold; text-align: center; margin-top: 20px;">Daily Uptime Table</div><br>'
            for table in daily_uptime_html:
                html_content += table + '<div class="page-break"></div>'
